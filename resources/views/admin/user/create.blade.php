                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" name="start_from" class="form-control @error('start_from') is-invalid @enderror" placeholder="yyyy-mm-dd"  pattern="\d{4}-\d{2}-\d{2}" wire:model.lazy="start_from">
                                @error('start_from')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                ...
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label>Role</label>
                                <select class="form-control @error('') is-invalid @enderror" name="role_id" required="">
